...
> **注意**：由于 sing-box 配置格式的更新较为频繁，且淘汰速率较快，因此本文可能会不定期更新，尽量兼容最新的 sing-box 核心。目前，本文兼容的 sing-box 核心版本为 1.11.5（截止至 2025 年 3 月 27 日，Android 平台上的 sing-box 最新稳定版的核心版本为 1.11.5）。
